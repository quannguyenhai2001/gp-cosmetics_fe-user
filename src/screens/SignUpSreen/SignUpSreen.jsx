...
import { fetchAsyncSignUp } from 'redux/slices/UserSlice';
...
const SignUpScreen = () => {
    ...
    const handleSubmit = async (value) => {
        try {
            let valueObj = { ...value }
            delete valueObj['firstName']
            delete valueObj['lastName']
            ...
            await dispatch(fetchAsyncSignUp(userData)).unwrap()
            navigate("/sign-in")
                                ...
                                <Paper elevation={3} className={classes.paper}>
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Field
                                            ...
                                            component={InputField}
                                            label="Mật khẩu"
                                            type={showInput["password"] ? "text" : "password"} handleShowPassword={handleShowPassword}
                                        />
                                        <Field
                                            name="confirmPassword"
                                            component={InputField}
                                            label="Xác nhận mật khẩu"
                                            type={showInput["confirmPassword"] ? "text" : "password"} handleShowPassword={handleShowPassword}
                                        />
